    ...
    <div className="min-h-screen bg-off-white py-12">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-deep-navy mb-4">Our Book Collection</h1>
          <p className="text-deep-navy/70 max-w-2xl mx-auto">
            Browse our collection of clean, family-friendly books. Each book has been carefully edited to maintain the story's integrity while removing explicit content.
          </p>
        </div>
        ...
        {sortedBooks.length > 0 ? (
                ...
                <Card className="h-full overflow-hidden hover:shadow-lg transition-shadow duration-300">
                  <CardContent className="p-0">
                    ...
                    <div className="p-4">
                      ...
                      <p className="text-sm text-deep-navy/70 mb-2">{book.author}</p>
          ...
          <div className="text-center py-12">
            <h3 className="text-xl font-semibold text-deep-navy mb-2">No books found</h3>
            <p className="text-deep-navy/70">Try adjusting your search or filter criteria</p>
          </div>
        )}
      </div>
    </div>
